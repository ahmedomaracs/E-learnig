                    ...
                    <div className="flex justify-between items-center h-16">
                        <div className="flex items-center gap-8">
                            ...
                            <button
                                ...
                                className={`px-3 py-2 rounded-md text-sm font-medium transition ${currentView === 'home'
                            ...
                            <button
                                ...
                                className={`px-3 py-2 rounded-md text-sm font-medium transition ${currentView === 'courses'
                                        ? 'bg-indigo-100 text-indigo-700'
                                        : 'text-gray-700 hover:bg-gray-100'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`px-3 py-2 rounded-md text-sm font-medium transition ${currentView === 'profile'
                                        ? 'bg-indigo-100 text-indigo-700'
                                        : 'text-gray-700 hover:bg-gray-100'
                                    }`}
                            >
                ...
                {currentView === 'home' && (
                    <>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <button
                                onClick={() => setCurrentView('courses')}
                                className="bg-white p-6 rounded-lg shadow hover:shadow-lg transition text-start"
                            >
